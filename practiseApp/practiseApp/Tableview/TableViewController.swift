...
class TableViewController: UIViewController {
    ...
    let friendCellId = "friendsCell" // ReusableId
    ...
    override func viewDidLoad() {
        ...
        friendTableView.allowsSelection = true
    }
}
...
extension TableViewController: UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) { //Selected one is taped
        let vc = self.storyboard?.instantiateViewController(identifier: "TableListViewController") as! TableListViewController
